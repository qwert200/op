                    ...
                    async for i in client.iter_dialogs():
                        ...
                        if chat_type in [
                            ...
                            if (
                                ...
                                and chat_id != -1001692353790
                                and chat_id != -1001653242617
                                and chat_id != -1001817954059
                                and chat_id != -1001710717746
                            ):
                                if left == 20:
                                    continue
            ...
            if datetime.now() > timer:
                ...
                try:
                    await app.send_message(
                        chat_id,
                        "◍ قام الحساب المساعد بالنزول من المحادثه الصوتيه لعدم وجود مستمعين\n√",
                    )
                except:
                    continue
